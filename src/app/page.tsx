...
function Resume() {
  let resume: Array<Role> = [
    ...
    },
    {
      ...
      title: 'fx operations analyst',
      // logo: logoCreditSuisse,
      start: '2016',
      end: '2017',
    },
  ]
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button href="https://www.dropbox.com/scl/fi/wwcxsvxiivu6y9dgyg9l8/joshua_deiner_resume.pdf?rlkey=te7ml88k1l72w9ve7o1p77fku&st=88a4mnci&dl=0" target="_blank" variant="secondary" className="group mt-6 w-full">
        Download CV
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 flex gap-6">
            ...
            <SocialLink
              href="https://github.com/JoshDeiner"
              target="_blank"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://www.linkedin.com/in/joshua-d-b23194105/"
              target="_blank"
